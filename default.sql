...
1,NULL,NULL,"descripcion ",80,"Ruta Santa Rosa - Capitán Bado","<p>MINISTERIO DE OBRAS P&Uacute;BLICAS Y COMUNICACIONES.&nbsp;<br />
...
insert into default.obras(id,created_at,updated_at,descripcion,imagen,titulo_obra,contenido_obra,introduccion)values(7,NULL,NULL,"descripcion ",89,"Avda. Madame Lynch","<p>MINISTERIO DE OBRAS P&Uacute;BLICAS Y COMUNICACIONES.&nbsp;<br />
