...
/*layersliders*/
insert into layersliders values(1,'obras','layerslider centrar','width: 1280px; height: 500px;');

insert into sliders values(1,1,'ls-slide','slidedelay: 7000; transition2d: 75,79;');

insert into layers values(1,1,'img','ls-bg',null,null,'/images/obras/81_1.jpg','Slide background',null);
insert into layers values(2,1,'p','ls-l','durationin:1500;delayin:3300;rotatein:20;rotatexin:30;scalexin:1.5;scaleyin:1.5;transformoriginin:left 50% 0;durationout:750;rotateout:20;rotatexout:-30;scalexout:0;scaleyout:0;transformoriginout:left 50% 0;','top:70px;left:10px;font-weight:300;height:40px;padding-right:10px;padding-left:10px;font-size:30px;line-height:37px;color:#ffffff;background:#3D82DA;border-radius:4px;white-space: nowrap;',null,null,'Aeropuerto Internacional Guaraní');
insert into layers values(3,1,'p','ls-l','durationin:1500;delayin:4300;rotatein:20;rotatexin:30;scalexin:1.5;scaleyin:1.5;transformoriginin:left 50% 0;durationout:750;rotateout:20;rotatexout:-30;scalexout:0;scaleyout:0;transformoriginout:left 50% 0;','top:130px;left:10px;font-weight: 300;height:40px;padding-right:10px;padding-left:10px;font-size:30px;line-height:37px;color:#ffffff;background:#3D82DA;border-radius:4px;white-space: nowrap;',null,null,'EDB Construcciones');
