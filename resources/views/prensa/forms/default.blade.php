  ...
  <div class="form-group">
   ...
   <input type="text" class="form-control" id="titulo" name="titulo" aria-describedby="emailHelp" placeholder="titulo"  @if(isset($prensa)) value="{{ $prensa->titulo }}" @endif @if($disabled) disabled @endif>
